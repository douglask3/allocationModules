...
class total_canopy_LAI(object):
    ...
    def Ltotopt(self, ntot, nabase, ltotsoln = 3.0):
    ...
    def _Ltotupt(self,*args,Ltotsol=5.0):
        newton( self.C_Nball,Ltotsol, args = (args))
        
    def Ltotupt(self,*args): return( m*self.Mastar*w
