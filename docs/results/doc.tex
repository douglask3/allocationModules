...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.85\textwidth]{-SEASONAL-fixed-allometric-maxGPP-maxWOOD-leafAl-woodAl-rootAl-.pdf}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.55\textwidth]{-ANNUAL-fixed-allometric-maxGPP-maxWOOD-leafAl-woodAl-rootAl-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.55\textwidth]{-ANNUAL-fixed-allometric-maxGPP-maxWOOD-NPP-GPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.85\textwidth]{-ANNUAL-fixed-allometric-maxGPP-maxWOOD-NPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.85\textwidth]{-SEASONAL-fixed-allometric-maxGPP-maxWOOD-NPP-GPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.85\textwidth]{-SEASONAL-fixed-allometric-maxGPP-maxWOOD-NPP-}
