...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.5\textwidth]{-SEASONAL-fixed-allocation-maxGPP-maxWOOD-leafAl-woodAl-rootAl-.pdf}
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=0.5\textwidth]{-ANNUAL-fixed-allocation-maxGPP-maxWOOD-leafAl-woodAl-rootAl-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.5\textwidth]{-ANNUAL-fixed-allocation-maxGPP-maxWOOD-NPP-GPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.5\textwidth]{-ANNUAL-fixed-allocation-maxGPP-maxWOOD-NPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.5\textwidth]{-SEASONAL-fixed-allocation-maxGPP-maxWOOD-NPP-GPP-.pdf}
...
\begin{figure}[h]
  \centering
    \includegraphics[width=0.5\textwidth]{-SEASONAL-fixed-allocation-maxGPP-maxWOOD-NPP-}
